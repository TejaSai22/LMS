...
-- Content Entities
\i code/sql/schema/10_module.sql \i code/sql/schema/11_material.sql

-- Grading Entity
\i code/sql/schema/12_grade.sql
\i code/sql/schema/13_course_prerequisite.sql

-- Views, Indexes, and Triggers
\i code/sql/views.sql
\i code/sql/indexes.sql
\i code/sql/triggers.sql

-- Seed Data (Optional - run separately or uncomment)
-- \i code/sql/seed_final.sql
-- \i code/sql/seed_extended.sql